-- =============================================================================
-- 给 Supabase「SQL Editor」用：只粘贴本文件从下一行起的全部内容，点 Run。
-- 不要粘贴 bash / 终端命令（会报 syntax error at or near "bash"）。
-- 更新迁移后请执行：bash scripts/print-supabase-migrations.sh > infra/migrations/ALL_FOR_SQL_EDITOR.sql
-- =============================================================================
